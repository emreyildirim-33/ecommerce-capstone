...
This project demonstrates a modern e-commerce frontend experience built with React and Redux.
...
The main focus is building a clean user interface, managing application state, structuring reusable components, and improving the shopping flow.
...
Using centralized state management helps keep cart and wishlist logic consistent across different pages.
...
This project focuses on React, Redux, routing, responsive UI development, reusable components, cart management, wishlist functionality, and frontend state management.

The main purpose is to demonstrate frontend architecture, state management, and e-commerce user flow implementation rather than building a full production marketplace.
